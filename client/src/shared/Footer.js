          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-sm ">
            ...
            <div>
              ...
              <div className="mt-6 flex items-center space-x-3 sm:space-x-4">
                <a href="https://play.google.com" target="_blank" className="block">
                  <img
                    src="/google.webp"
                    alt="Google Play"
                    className="h-8 sm:h-10 md:h-8 w-auto object-contain hover:opacity-80 transition-opacity"
                  />
                </a>
                <a href="https://apps.apple.com" target="_blank" className="block">
                  <img
                    src="/apple.webp"
                    alt="App Store"
                    className="h-8 sm:h-10 md:h-8 w-auto object-contain hover:opacity-80 transition-opacity"
